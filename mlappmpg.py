...
#define multiple models as Dictionary
...
if selected_model=='Linear Regression':
    ...
    n_estimators=st.sidebar.slider("No. of Trees",100,500,50)
    model=RandomForestRegressor(n_estimators=n_estimators)
elif selected_model=='GradientBoosting':
    n_estimators=st.sidebar.slider('Num of Tress',100,500,50)
...
st.title('Predict Mileage pe Gallon')
